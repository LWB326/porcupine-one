...
$app->get('/admin/comment/{id}/resetSig', "MicroCMS\Controller\AdminController::resetSigCommentAction")
->bind('admin_comment_resetSig');

// Increase of a comment report counter
$app->get('/home/comment/{id}/incSig', "MicroCMS\Controller\HomeController::incSigCommentAction")
->bind('home_comment_incSig');

/* Add a new comment
$app->match('/home/comment/add', "MicroCMS\Controller\HomeController::addCommentAction")
->bind('home_comment_add');
*/
