...
class AdminController {
    ...
    public function deleteArticleAction($id, Application $app) {
        ...
        $app['session']->getFlashBag()->add('success', 'Ce chapitre a été supprimé avec succès');
    ...
    public function deleteCommentAction($id, Application $app) {
        ...
        $app['session']->getFlashBag()->add('success', 'Ce commentaire a été supprimé avec succès.');
        // Redirect to admin home page
        return $app->redirect($app['url_generator']->generate('admin'));
    }
    ...
    public function editUserAction($id, Request $request, Application $app) {
        ...
        if ($userForm->isSubmitted() && $userForm->isValid()) {
            ...
            $user->setPassword($password); 
            $app['dao.user']->save($user);
            $app['session']->getFlashBag()->add('success', 'Mise à jour compte utilisateur réalisée.');
        }
        return $app['twig']->render('user_form.html.twig', array(
	 ...
	 */
	public function resetSigCommentAction($id, Application $app) {
       	$app['dao.comment']->resetSig($id);
