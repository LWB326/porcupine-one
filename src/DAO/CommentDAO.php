...
class CommentDAO extends DAO 
{
     ...
     */
      public function findAllByArticle($articleId) {
        ...
        $sql = "select com_id, com_content, usr_id, sig_cp, father_id from t_comment where art_id=? order by com_id";
    ...
    protected function buildDomainObject(array $row) {
		...
		$comment->setSignal($row['sig_cp']);
		$comment->setFather($row['father_id']);
	...
	/**
     * Increases signal counter of a comment
     *
     * @param integer $id The id of the comment
     */
	public function incSig($id){
	...
	/**
     * Resets to a zero value the signal counter of a comment
     *
     * @param integer $id The id of the comment
     */
	public function resetSig($id){
		$newSigCp = 0;
